...
$html.='<body style="margin: 0;">';
    ...
    $html.='<div class="nav container">Last Updated Date: '. substr($dmplastUpdateDate,0,10);
    ...
    $html.='<ul class="right hide-on-med-and-down">';
        $html.='<input id="download-button" class="btn waves-effect waves-light orange" type="button" onClick=parent.location="index.html" value="Back to Home">';
                //. '<a href="view_all_dmps.php" id="download-button" class="btn-large waves-effect waves-light orange">Get Started</a>';
        
      $html.='</div>';
    //$html.='<ul class="right hide-on-med-and-down">';
    //$html.='<li><input class="card blue-text darken-4" type="button" onClick=parent.location="index.html" value="Back to Home"></li>';
    //$html.='</ul>';
    //$html.='</div';
    ...
    $html.='</div>';
    $html.='</nav>';
    $html.='<div class="header center orange-text section no-pad-bot">';
    $html.='<h1>Data Management Plan</h1>';
    ...
    $html.='<h5 class="header col s12 light-blue-text text-darken-4">Project: "'. $project_title .'" </h5>';
    //$html.='<h5>Project: "'. $project_title .'" </h5>';
    $html.='</div>';
      $html.='<br>';
    $html.='</div>';
  $html.='</div>';
...
$res13=[$policyRequirements_id, $policyreq_controllingBody, $policyreq_relevantText];
   ...
   $html.='<div clas="section">';
      ...
      $html.='<div class="row">';
            ...
            $html.='<p class="light light-blue-text text-lighten-1">Field of Research: ';
            ...
            $var=$i+1;
            $html.='<p style="bgcolor:#B0E0E6;"><h5>'. (string)$var .' - '.$da_shortname[$i].'</h5></p>';
            ...
            $html.='<h4>Roles and Responsibilites</h4></p>';
            ...
            $html.='<h4>Ethics and Privacy</h4></p>';
            $html.='<div class="card-panel">';
